...
<nav id="pageNav" class="navbar navbar-default">
	<a href="<?php echo site_url(); ?>" class="navbar-brand"><?php echo ucwords($site_name); ?></a>
	<div class="container-fluid">
		...
		<div class="navbar-collapse collapse" id="menu">
			<ul class="nav navbar-nav" id="primaryLinks">
				<li <?php echo isset($page_title) && strtolower($page_title) == "concert" ? "class='active'" : ""; ?>><?php echo anchor("concert", "CONCERTS"); ?></li>
				<li <?php echo isset($page_title) && strtolower($page_title) == "sport" ? "class='active'" : ""; ?>><?php echo anchor("sport", "SPORT EVENTS"); ?></li>
				<li <?php echo isset($page_title) && strtolower($page_title) == "festival" ? "class='active'" : ""; ?>><?php echo anchor("festival", "FESTIVALS"); ?></li>
