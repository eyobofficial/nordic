<section id="adminNotification">
	...
	<p class="text-center">You have <a href="all_messages.php">
		<?php echo $inbox == 0 ? 'No new message' : $inbox . 'Messages'; ?>
	</a></p>
</section>
...
<nav class="row">
	<ul class="list-unstyled pull-right">
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage dashboard" ? 'class="active"' : ""; ?> ><a href="index.php">Dashboard</a></li>

		<!-- EVENT NAVIGATION -->
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage events"    ? 'class="active"' : ""; ?> ><a href="all_events.php">Events</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage events"): ?>
		...
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage tickets"  ? 'class="active"' : ""; ?> ><a href="all_tickets.php">Tickets</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage tickets"): ?>
			<ul class="secondaryNav">
		...
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage delivery"  ? 'class="active"' : ""; ?> ><a href="all_delivery.php">Delivery Methods</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage delivery"): ?>
			<ul class="secondaryNav">
		...
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage users"     ? 'class="active"' : ""; ?> ><a href="all_users.php">Users</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage users"): ?>
			<!-- <ul class="secondaryNav">
		...
		<?php if( (int)$logged_admin->privilege === 1): ?>
			<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage admins"  ? 'class="active"' : ""; ?> ><a href="all_admins.php">Admins</a>
				<?php if(isset($admin_section) && strtolower($admin_section) == "manage admins"): ?>
				<ul class="secondaryNav">
		...
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage messages"  ? 'class="active"' : ""; ?> ><a href="all_messages.php">Messages</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage messages"): ?>
			<ul class="secondaryNav">
		...
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage orders"  ? 'class="active"' : ""; ?> ><a href="all_orders.php">Orders</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage orders"): ?>
			<ul class="secondaryNav">
		...
		<li <?php echo  isset($admin_section) && strtolower($admin_section) == "manage settings"  ? 'class="active"' : ""; ?> ><a href="general_settings.php">Settings</a>
			<?php if(isset($admin_section) && strtolower($admin_section) == "manage settings"): ?>
			<ul class="secondaryNav">
