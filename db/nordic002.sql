...
DROP TABLE IF EXISTS `cat_names`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `cat_names` WRITE;
/*!40000 ALTER TABLE `cat_names` DISABLE KEYS */;
/*!40000 ALTER TABLE `cat_names` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `event_overviews`
--

DROP TABLE IF EXISTS `event_overviews`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_overviews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lang_id` int(11) NOT NULL DEFAULT '1',
  `overview` text,
  `created_date` datetime NOT NULL,
...
--
-- Dumping data for table `event_overviews`
--

LOCK TABLES `event_overviews` WRITE;
/*!40000 ALTER TABLE `event_overviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `event_overviews` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `event_titles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_titles` (
  ...
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `lang_id` (`lang_id`,`event_title`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `event_titles` WRITE;
/*!40000 ALTER TABLE `event_titles` DISABLE KEYS */;
/*!40000 ALTER TABLE `event_titles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-12-30 11:07:37
