...
INSERT INTO `cat_langs` VALUES (1,8,4,'Exhibitionist','lsdfls','2017-01-20 11:25:04','2017-01-20 08:25:04');
...
CREATE TABLE `catagories` (
  ...
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `default_title` (`default_title`)
...
INSERT INTO `catagories` VALUES (6,'Sport Events','Soccer, <br />\r\nand others<br />\r\n ','NO_CATAGORY_PHOTO.JPG','2017-01-08 13:13:16','2017-01-19 13:17:29'),(8,'Exhibition','','NO_CATAGORY_PHOTO.JPG','2017-01-19 14:28:48','2017-01-19 11:28:48'),(9,'Inauguration','donland trump','NO_CATAGORY_PHOTO.JPG','2017-01-20 12:18:01','2017-01-20 09:18:01'),(10,'Africa','','NO_CATAGORY_PHOTO.JPG','2017-01-20 12:44:55','2017-01-20 09:44:55');
...
INSERT INTO `event_langs` VALUES (7,5,6,'Iaglo Iye','lsoremsls lseip lsdlkf sidisiso','2017-01-19 20:46:42','2017-01-19 17:46:42');
...
CREATE TABLE `events` (
  ...
  KEY `title_id` (`slug`,`venue`,`city`,`country_id`,`event_date`),
  KEY `slug` (`slug`),
  KEY `venue` (`venue`),
  KEY `city` (`city`),
...
INSERT INTO `events` VALUES (5,8,'Eagle Eye','','Handles translations for the a Catagory (i.e. Add, Edit and Delete translations)','Millennium Hall','Addis Ababa',210,NULL,0,1,'NO_PHOTO.JPG','NO_SEATING_PHOTO.JPG','2017-01-19 20:45:00','2017-01-19 18:32:29');
...
INSERT INTO `langs` VALUES (4,'svenska','SV',0,'2017-01-08 19:16:22','2017-01-08 16:16:22'),(6,'french','FR',0,'2017-01-18 12:14:43','2017-01-18 09:14:43'),(7,'amharic','AM',0,'2017-01-18 12:16:36','2017-01-18 09:16:36');
...
-- Dump completed on 2017-01-21  7:37:31
